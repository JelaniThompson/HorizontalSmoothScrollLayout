...
setTimeout(function () {
  ...
  var containerTwoTarget = document.querySelector("#container-two");
  var containerThreeTarget = document.querySelector("#container-three");
...
}, 0); // let observer = new IntersectionObserver(callback, options)
